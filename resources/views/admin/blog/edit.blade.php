                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="" class="form-horizontal form-material" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="title" placeholder="Nhap title" class="form-control form-control-line" value="{{ $data->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="content" class="form-control form-control-line" id="add1"></textarea>
                                        </div>
                                    </div> -->
                                    <div class="form-group">
                                        <div class="col-sm-12">
